(function() {
    ...
    var t = Math.random();
    $.ajax({
        url: '/api/sk/game/config/practice?'+t,
        async: false,
    ...
    Game.prototype = {
        ...
        nextLevel: function() {
            ...
            if (self.level <= self.levelLength) {
                ...
                $("#levelSwitchBoxMain").attr("src", "https://img.jammyfm.com/media/image/songquiz_assets/mxtkgo/level_" + self.level + "_main.png");
                $("#levelSwitchBox").show();
